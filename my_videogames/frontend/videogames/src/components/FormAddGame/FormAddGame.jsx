...
function FormAddGame({ isOpen, onClose, onSave }) {
    ...
    return (
        ...
        <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-xl dark:bg-gray-800">
            <h2 className="text-xl font-semibold mb-4 dark:text-white">Register New Videogame</h2>
            ...
            <div className="flex justify-end gap-2">
                <button type="button" onClick={handleCancel} className="px-4 py-2 bg-red-600 rounded hover:bg-red-400">
                    Cancel
                </button>
